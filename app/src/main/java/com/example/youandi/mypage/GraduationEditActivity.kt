...
class GraduationEditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editBtn.setOnClickListener {
            if(imgUri==null){
                ...
                var body : MultipartBody.Part = MultipartBody.Part.createFormData("uploadGraduationFile","test",requestBody)
                ...
                //creating our api
                var server = retrofit.create(gFileInterface::class.java)
