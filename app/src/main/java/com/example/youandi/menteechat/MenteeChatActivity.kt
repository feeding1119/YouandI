...
class MenteeChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var mName= intent.getStringExtra("mentor_name")
        ...
        var retrofit =
            Retrofit.Builder()
                ...
                .build()
        val sendService = retrofit.create(chatInterface::class.java)
        val getService = retrofit.create(chatDataInterface::class.java)
//        var user_id = intent.getStringExtra("user_id")
        ...
        testBtn.setOnClickListener {
            ...
            btn?.setOnClickListener {
                ...
                var mentorId = intent.getStringExtra("mentor_id")
                val sendText = mAlertDialog.findViewById<EditText>(R.id.sendTextArea)?.text.toString()

                sendService.getChat(myClass.user_id,mentorId!!,sendText).enqueue(object : Callback<ResponseBody> {
                    override fun onResponse(
